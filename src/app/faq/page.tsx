...
const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "חולצה עם שם ומספר מיוצרת במיוחד עבורכם, ולכן אינה ניתנת לביטול או להחזרה. חולצה ללא הדפסה אישית ניתן לבטל בתוך 14 יום מקבלת ההזמנה, כשהיא חדשה ולא נעשה בה שימוש; ייתכנו דמי ביטול לפי חוק (עד 5% ממחיר הפריט או עד 100 ₪, לפי הנמוך) ודמי המשלוח בחזרה חלים על הלקוח. פריט פגום או שאינו תואם לתיאור — נחליף או נזכה במלואו. לתיאום כתבו לנו בוואטסאפ.",
  },
  {
    q: "איך מתבצע התשלום?",
