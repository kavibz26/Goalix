      ...
      <Container className="flex flex-col gap-14">
        {!catalogReady ? (
          <Reveal>
            <EmptyState
              title="הקטלוג בהכנה"
              hint="נתוני הקבוצות והחולצות (products.json) יתווספו בקרוב. שאר האתר כבר מוכן."
            />
          </Reveal>
        ) : null}
            ...
            <section>
              <SectionHeader
                ...
                action={
                  ...
                  >
                    לכל החולצות <ArrowLeft className="h-4 w-4 rtl:rotate-180" />
                  </Link>
                }
              />
            ...
            <SectionHeader
              ...
              action={
                <Link
                  ...
                  className="inline-flex items-center gap-1 text-sm font-semibold text-accent"
                >
                  לכל המבצעים <ArrowLeft className="h-4 w-4 rtl:rotate-180" />
                </Link>
              }
            />
            {deals.length > 0 ? (
              <ul className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                {deals.slice(0, 3).map((d) => (
                  ...
                  >
                    ...
                    <p className="mt-3 font-semibold">{d.title_he ?? d.title}</p>
                  </li>
                ))}
              </ul>
            ) : (
              <EmptyState
                ...
                hint="מבצעים אמיתיים יתווספו מתוך deals.json."
              />
            )}
          </section>
        </Reveal>
        ...
        <Reveal>
          <section>
            ...
            {teams.length > 0 ? (
              ...
              <EmptyState title="רשימת הקבוצות תתווסף בקרוב" />
            )}
          </section>
        </Reveal>
        ...
        <Reveal>
          <div className="flex flex-col items-center gap-4 rounded-2xl border border-border bg-surface p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <WhatsAppButton
                href={whatsappUrl(
                  "Hi, I need help choosing a kit from FootballKits-il",
                )}
              />
            </div>
          </div>
